...
def task1():
    def get_stdlib_packages():
        major, minor = sys.version_info.major, sys.version_info.minor  # get Python version majpr.minor
        assert major == 3, "Python3 is used in this project."

        if 5 <= minor <= 9:
            stdlibs = set(eval("isort.stdlibs.py39.stdlib"))
        elif minor >= 10:
